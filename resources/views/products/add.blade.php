                            ...
                            <div class="flex-1 px-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <input onkeydown="numbersOnlyKeydown(event)" required class="block w-full rounded {{$errors->has('stock') ? 'border-red-500' : ''}}" type="number" min="1" value="{{old('stock') ? old('stock') : 1}}" onkeypress="numbersOnly(event)" name="stock" id="stock">
                                    </div>
                                </div>
